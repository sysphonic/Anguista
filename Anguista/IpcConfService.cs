...
{
    /// <summary>IPC-Remoting service of Anguista.Main process.</summary>
    public class IpcConfService : MarshalByRefObject, Anguista.Lib.IIpcConfService
    {
        ...
        public event EventHandler<Anguista.Lib.TaskProcClosingEventArgs> TaskProcClosing;
        ...
        public void FireEventTaskProcClosing()
        {
            ...
            {
                TaskProcClosing(this, new Anguista.Lib.TaskProcClosingEventArgs());
            }
        }
    }
}
