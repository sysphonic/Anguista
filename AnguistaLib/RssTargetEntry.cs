        ...
        public string NewPath
        {
            get
            {
                if (_title == null)
                    ...
                    return Path.Combine(Anguista.Lib.Def.INFO_ROOT_DIR, _EncForPath(_title));
            }
        }
        ...
        public string CurPath
        {
            get
            {
                if (_dirTitle == null)
                    ...
                    return Path.Combine(Anguista.Lib.Def.INFO_ROOT_DIR, _EncForPath(_dirTitle));
            }
        }
...
//                formatter.Serialize(file, feedHistory);
        ...
        public Boolean LoadFeedHistory()
        {
